...
public class sellProduct extends  TransitionsForm{
    ...
    private void initComponents() {
        ...
        TotalAmount.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        TotalAmount.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204), 2));
    ...
    private void butButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_butButtonMouseClicked
        ...
        } else if (productName.getText().isEmpty() || price.getText().isEmpty() || quantity.getText().isEmpty() || cash.getText().isEmpty()) {
